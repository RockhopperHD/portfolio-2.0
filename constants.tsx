...
export const CLIPBOARD_CONTENTS: ClipboardContent[] = [
    ...
    {id: "clipboard-extra-marist-circle", content: ( <><h4>Journalistic Skills & Marist Circle Contributions</h4> <p>This is the newspaper club at Marist University. You can view my work <a href="#" className="text-[#8ab4f8] underline hover:text-[#a7c5f9]">here</a>. All of my articles are on topics that I found interesting, or just general happenings on campus. I pride myself in variety and quality writing. I published as much as two articles an issue while still keeping interesting topics at the center. As an editor, I took great care in not only polishing work of my fellow writers but mentoring others and ensuring long-term change and improvement.</p></>)},
    ...
    {id: "clipboard-extra-mosaic", content: ( <><h4>Marist Mosaic Poem Details</h4><p>I got published in Marist Univeristy's Mosaic magazine in 2025. My poem is featured <a href="#" className="text-[#8ab4f8] underline hover:text-[#a7c5f9]">here</a>.</p></>)}
];
