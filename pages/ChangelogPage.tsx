...
const ChangelogPage: React.FC = () => {
  ...
  return (
    <SubPageLayout title="Website Changelog" subtitle="Recent updates and improvements to the portfolio site.">
      <div>
        <ChangelogEntry title="May 2026 Portfolio Update" date="May 20, 2026">
          <li>Updated resume information for senior year, <em>Marist Circle</em> Editor-in-Chief, and Digital Education work.</li>
          <li>Added Iquan to the Projects page with screenshots and a direct project link.</li>
          <li>Made Skills page pills link directly to matching resume sections.</li>
        </ChangelogEntry>
        <ChangelogEntry title="Portfoliotizing" date="January 18, 2026">
          ...
          <li>Updated my resume and skill pages</li>
        </ChangelogEntry>
        ...
        <ChangelogEntry title="React Migration & Feature Overhaul" date="October 2, 2025">
          <li>The website now uses React and TypeScript; it is not one HTML file.</li>
          <li>Completely redesigned the Highlights section into an interactive, looping carousel of portfolio cards.</li>
          <li>Enriched all portfolio item descriptions with detailed context from the resume.</li>
        ...
        <ChangelogEntry title="Initial Launch" date="June 8, 2025">
          <li>The first version of the website was launched, featuring a light theme and the core sections: About, Skills, Projects, Extras, and Resume.</li>
        </ChangelogEntry>
      </div>
    </SubPageLayout>
  );
