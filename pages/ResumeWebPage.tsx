            ...
            <div className="bg-soft-gray-bg p-6 sm:p-8 rounded-lg shadow-lg border border-medium-gray-bg font-sans">
                ...
                <Entry title="Smile & Learn, AINARA" pills={['Part Time Internship', 'Fall 2025']} location="MADRID, SPAIN">
                    <ul className="list-disc pl-5 space-y-1">
                        <li>Personally created a new personality for AINARA's AI chat bot, prioritizing coding and an educational tone</li>
                        <li>Created a tool that allows educators to create games with AI, then modify them with automatically generated parameters, all within a premade and customizable template system; presented progress and findings to CEO</li>
                    </ul>
                </Entry>
