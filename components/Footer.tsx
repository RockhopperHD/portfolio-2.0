...
const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
    return (
        <footer id="page-footer" className="bg-[#1a1a1a] text-light-text py-10 px-5 md:px-10 text-center text-shadow-lg border-t border-black">
            ...
            <p className="text-sm text-medium-gray-bg mt-4">Last updated in September 2025.</p>
            <p className="text-xs text-medium-gray-bg italic mt-6">This site was coded with AI and augmented with my knowledge of HTML and graphic design.</p>
